...
export type SearchMediaQueryQuery = {
	__typename?: "Query";
	searchMedia: {
		__typename?: "SearchResultOfMediaIndex";
		totalFound?: number | null;
		totalCount: number;
		searchDuration: number;
		hits: Array<{
			__typename?: "SearchHitOfMediaIndex";
...
export const SearchMediaQueryDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "searchMediaQuery" },
			variableDefinitions: [
				{
				...
				selections: [
					{
						...
						arguments: [
							{
								...
								value: {
									...
									fields: [
										...
										{
											kind: "ObjectField",
											name: { kind: "Name", value: "pageNr" },
											value: { kind: "IntValue", value: "0" },
										},
										{
											kind: "ObjectField",
											name: { kind: "Name", value: "facetBy" },
											value: {
												kind: "ListValue",
												values: [
													{
														kind: "StringValue",
														value: "date_taken.year",
														block: false,
													},
												],
											},
						...
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "totalFound" } },
								{ kind: "Field", name: { kind: "Name", value: "totalCount" } },
								{
									kind: "Field",
									name: { kind: "Name", value: "searchDuration" },
								},
								{
									kind: "Field",
									...
									selectionSet: {
										...
										selections: [
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "geoDistance" },
												selectionSet: {
													kind: "SelectionSet",
													selections: [
														{
											...
											},
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{
															kind: "Field",
															name: { kind: "Name", value: "faces" },
															selectionSet: {
																kind: "SelectionSet",
																selections: [
																	{
																		kind: "Field",
																		name: { kind: "Name", value: "faceId" },
																	},
																	{
																		kind: "Field",
								...
								},
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "totalValues" },
											},
											{
												kind: "Field",
	...
	SearchMediaQueryQuery,
	SearchMediaQueryQueryVariables
>;
