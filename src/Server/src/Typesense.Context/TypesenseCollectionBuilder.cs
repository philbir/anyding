...
public class TypesenseCollectionBuilder<TDocument> : ITypesenseCollectionBuilder<TDocument>
{
    ...
    public ITypesenseCollectionBuilder<TDocument> AddField<TProperty>(
        ...
        bool optional = false)
    {
        _fields.Add(new Field(FieldNameResolver.CreateFieldName(propertyExpression), type, facet, optional));
    ...
    public ITypesenseCollectionBuilder<TDocument> AddField<TProperty>(
        ...
        Field field)
    {
        _fields.Add(field with { Name = FieldNameResolver.CreateFieldName(propertyExpression) });
